...
class FruitParserTests: XCTestCase {
    ...
    func testSimpleLayout() {
        ...
        XCTAssertEqual(viewToken.fileName, "Layouts/Default.nut.html")
    ...
    func testSimpleView() {
        ...
        XCTAssertEqual(viewToken.fileName, "Subviews/Smt.nut.html")
        let jsonExp = try! JSON(json: content)
        XCTAssertEqual(jsonExp, viewToken.serialized)
    }
