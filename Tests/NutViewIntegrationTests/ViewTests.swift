...
struct Post {
    ...
    init(id: String, title: String, body: String, brief: String, likes: Int = 0, dislikes: Int = 0) {
        self.id = id
        self.title = title
        self.body = body
        self.brief = brief
...
//        NutConfig.clearFruits(removeRootDirectory: true)
    ...
    func testPost() {
        let data = Post(id: "59984722610934e182846e7b",
                        title: "Dogs", body: "Dogs are not cats!",
                        brief: "About dogs.", likes: 1, dislikes: 0)
